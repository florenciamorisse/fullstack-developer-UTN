    ...
    return(
        <main>
            {/* <section class="contenedor">
                ...
                <h1 class="titulo">PROYECTO ARQUITECTÓNICO</h1>        
                
            </section>  
                  
            <div class="img-main" >
                <img class="plano01" src="img/main/planning-1.jpg" height="100%" margin="30px 0 10px 0" alt=""/>
            ...
            <div class="titulo2">Qué hacemos</div>
            <div   div class="items" >
                <div class="items2 concepto">
                    <img class="cuadradas" src="img/main/concepto.png" alt=""/>
                    <p >
                        <h3>Concepto</h3><br/>
                ...
                <div class="items2">
                    <img class="cuadradas" src="img/main/proyecto.png" alt=""/>
                    <p>
                        <h3>Proyecto</h3><br/>
                        Lorem ipsum dolor sit amet consectetur 
                    </p>
                ...
                <div class="items2">
                    <img class="cuadradas" src="img/main/direccion.png" alt=""/>
                    <p>
                 ...
                 <div class="items2">
                    <img class="cuadradas" src="img/main/ejecucion.png" alt=""/>
                    <p >
                        <h3>Ejecución</h3><br/>
                        Lorem ipsum dolor sit amet consectetur.
                    </p>
                ...
                <div class="items2" >
                    <img class="cuadradas" src="img/main/planos.png" alt=""/>
                    <p>
